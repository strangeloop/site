...
contact_us_page.parts.create({
  :title => "Side Body",
  :body => "<p>623 Highland Glen Dr.<br/>Ballwin, MO 63021<br/>USA.<br/>Phone: 636-236-1376</p>",
  :position => 1
})
...
privacy_policy_page.parts.create({
  :title => "Body",
  :body => "<p>We respect your privacy. We do not market, rent or sell our email list to any outside parties.</p><p>We need your e-mail address so that we can ensure that the people using our forms are bona fide. It also allows us to send you e-mail newsletters and other communications, if you opt-in. Your postal address is required in order to send you information and pricing, if you request it.</p><p>Please call us at 636-236-1376 if you have any questions or concerns.</p>",
  :position => 0
})
